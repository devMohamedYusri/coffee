    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 ftco-animate">
                <form action="{{route('coffee.checkout.storeCheckout')}}" method="post"class="billing-form ftco-bg-dark p-3 p-md-5">
                    @CSRF
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname"class="form-control" value="{{Auth::user()->name}}"placeholder="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" name="apartment_suite_etc"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="total" value="{{Session::get('price')}}"class="form-control" hidden>
