                    ...
                    <form action="{{route('coffee.booking.store')}}" method="post" class="appointment-form" required>
                        ...
                        <div class="d-md-flex">
                            <div class="form-group">
                                <input type="text" name="first_name"class="form-control" value="{{Auth::user()->name}}"placeholder="First Name"required>
                        ...
                        <div class="d-md-flex">
                            <div class="form-group">
                                <div class="input-wrap">
                                    ...
                                    <input type="date"name="date" min="{{date('Y-m-d')}}"  value="{{date('Y-m-d')}}"placeholder="Date"required>
                                </div>
                            </div>
                            <div class="form-group ml-md-4">
                                <div class="input-wrap">
                                    <div class="icon"><span class="ion-ios-clock"></span></div>
                                    <input type="time"name="time" min="{{time()}}" value="{{time()}}" placeholder="Time"required>
                                </div>
                            </div>
                            <div class="form-group ml-md-4">
    ...
    <section class="ftco-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="menu-entry">
                        <a href="{{route('coffee.product.show',$product->id)}}" class="img" style="background-image: url({{asset($product->image)}});"></a>
                        <div class="text text-center pt-4">
                            <h3><a href=" {{route('coffee.product.show', $product->id)}}">{{$product->title}}</a></h3>
                            <p>{{$product->description}}</p>
                            <p class="price"><span>${{$product->price}}</span></p>
                            <p><a href=" {{route('coffee.product.show', $product->id)}}" class="btn btn-primary btn-outline-primary">Add to Cart</a></p>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="col-lg align-self-sm-end ftco-animate">
                    <div class="testimony">
                        ...
                        <div class="author d-flex mt-4">
                            ...
                            <div class="name align-self-center">{{$review->username}}<span class="position">{{$review->type_of_service}}</span></div>
                        </div>
                    </div>
                </div>
                @endforeach
